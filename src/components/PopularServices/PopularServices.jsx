      ...
      <section className={styles.popularServicesSection}>
        <div className={styles.overlay}>
          ...
          <p className={styles.popularServicesDescription}>
            Below are some of our most popular services that clients keep coming back for. Whether you&apos;re looking
            for a quick laser session or a luxurious deep-cleansing facial, we&apos;re here to help you look and feel
            your absolute best.
          </p>
          {/* Services */}
