          ...
          {expanded && (
            <>
              ...
              <p className={styles.dermaplaningText2}>
                ...
                scalpel. It's a painless, non-invasive treatment that instantly leaves your skin softer, smoother, and
                ready to better absorb skincare products.
              </p>
              <p className={styles.dermaplaningText2}>
                Many fear it makes hair grow back thicker — that's a myth! Vellus hair returns just as soft and fine as
                before. Plus, dermaplaning helps reduce the appearance of fine lines and gives makeup a flawless finish.
              </p>
