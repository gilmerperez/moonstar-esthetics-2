...
export default function AHAvsBHA() {
  return (
    <>
      <section className={styles.ahaVsBhaSection}>
        <div className={styles.overlay}>
          ...
          <p className={styles.ahaVsBhaDescription}>
            AHAs exfoliate the skin&apos;s surface for a smoother, brighter complexion—ideal for dry or sun-damaged
            skin. BHAs penetrate deep into pores to remove excess oil and impurities—perfect for oily or acne-prone
            skin.
          </p>
          {/* Columns */}
