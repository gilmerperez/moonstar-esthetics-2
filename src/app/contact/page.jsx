      ...
      <main>
        <div className={styles.contactContainer}>
          ...
          <p className={styles.contactDescription}>
            We&apos;d love to hear from you. Whether you have a question about our services, want to request a
            consultation, or simply want to say hello — feel free to reach out below.
          </p>
